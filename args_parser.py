...
# 11-3-21-20-model4-channel_32all_withconv6_1conv5_1-e300-b32-lr0.0001-lrce100ce200-haar-allpartcc_QB
    ...
    parser.add_argument('-e', '--epochs', type=int, default=2000, help='epoch of the train')# 500
    #parser.add_argument('--iters', type=int, default=25, help='epoch of the train')  # 376
    # data num / batch size  27 old

    # related with path  ---------------------------------------------------------
    # mat dataset path ----------------------------------------------------------------
    parser.add_argument('--data_path_mat_train', metavar='DIR', type=str, default=r'data\QB\train',
                        help='path to dataset')#
    parser.add_argument('--data_path_mat_val', metavar='DIR', type=str, default=r'data\QB\valid',
                        help='path to dataset') # default='data/GF2_9mat/val'   data/QB_allmat/val  WV4_453mat WV2_allmat
    parser.add_argument('--data_path_mat_test', metavar='DIR', type=str, default=r'data\QBtest',
                        help='path to dataset')


    parser.add_argument('--model_path', metavar='DIR', type=str, default=r'model',
                        help='path for trained models')
    parser.add_argument('--result_path', type=str, default=r'result',
                        help='directory for results')
    parser.add_argument('--result_path_full', type=str, default=r'result',
                        help='directory for results')
